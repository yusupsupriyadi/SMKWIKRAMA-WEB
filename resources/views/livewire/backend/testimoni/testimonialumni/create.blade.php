@section('back')
    <a class="btn btn-primary font-bold" href="{{ route('testimonialumni.index') }}">back</a>
@endsection
@section('title')
            ...
            <div class="col-md-12">
                ...
                <form wire:submit.prevent="store">
                    <div class="form-group">
                        <label>Nama</label>
                        <input class="form-control border-2 @error('nama') is-invalid @enderror" type="text" wire:model="nama" placeholder="Nama">
                        @error('nama')
