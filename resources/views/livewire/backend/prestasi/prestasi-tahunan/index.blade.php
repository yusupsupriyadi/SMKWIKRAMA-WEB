            ...
            <div class="col-md-12">
                ...
                <div class="bg-white p-4 rounded-2xl border-black border-l-2 border-r-2 border-t-2 border-b-8 shadow-xl">
                    <dir class="grid grid-cols-2 gap-4 ">
                        <div>
                            <a href="{{ route('prestasi-tahunan.create') }}" class="btn btn-primary">Tambah</a>
                        </div>
                        <div>
                            <input class="form-control rounded" type="text" wire:model="search" placeholder="Search ..">
                        </div>
                    </dir>
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>{{ $post->content }}</td>
                                <td>
                                    <a href="{{ route('prestasi-tahunan.edit', $post->id) }}" class="btn btn-warning">Edit</a>
