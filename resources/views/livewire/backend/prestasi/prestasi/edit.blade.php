@section('back')
    <a class="btn btn-primary font-bold" href="{{ route('prestasi.index') }}">back</a>
@endsection
@section('title')
    <h1 class="font-semibold text-yellow-600">DATA PRESTASI</h1>
@endsection
<div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form wire:submit.prevent="update">
                    ...
                    <div class="form-group">
                        <label>tanggal</label>
                        <input class="form-control @error('tanggal') is-invalid @enderror" type="text" wire:model="tanggal" placeholder="tanggal">
                        @error('tanggal')
