            ...
            <div class="col-md-12">
                ...
                <div class="bg-white p-4 rounded-2xl border-black border-l-2 border-r-2 border-t-2 border-b-8 shadow-xl">
                    <dir class="grid grid-cols-2 gap-4 ">
                        <div>
                            <a href="{{ route('lembagakerjasama.create') }}" class="btn btn-primary">Tambah</a>
                        </div>
                        <div>
                ...
                <table class="table table-bordered mt-2">
                    <thead class="bg-yellow-600 rounded-lg">
                        <tr>
                        <th scope="col">Nama Lembaga/Sekolah/Dinas</th>
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr>
                                <td>{{ $post->name }}</td>
                                <td>
                                    <a href="{{ route('lembagakerjasama.edit', $post->id) }}" class="btn btn-warning">Edit</a>
