@section('title')
    <h1 class="font-semibold text-yellow-600">DATA BDP</h1>
@endsection
<div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="bg-white p-4 rounded-2xl border-black border-l-2 border-r-2 border-t-2 border-b-8 shadow-xl">
                    <dir class="grid grid-cols-2 gap-4 ">
                        <div>
                            <a href="{{ route('bdp.create') }}" class="btn btn-primary">Tambah</a>
                        </div>
                        <div>
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('bdp.edit', $post->id) }}" class="btn btn-warning">Edit</a>
