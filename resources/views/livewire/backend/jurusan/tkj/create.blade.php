@section('back')
    <a class="btn btn-primary font-bold" href="{{ route('tkj.index') }}">back</a>
@endsection
@section('title')
    <h1 class="font-semibold text-yellow-600">DATA JURUSAN Teknik Komputer & Jaringan</h1>
@endsection
<div>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="form-group">
                        <label>pohon kompetensi</label>
                        <textarea class="form-control border-2 @error('pohon_kompetensi') is-invalid @enderror" type="text" wire:model="pohon_kompetensi" placeholder="pohon kompetensi"></textarea>
                        @error('pohon_kompetensi')
                        <span class="error text-red-600">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
