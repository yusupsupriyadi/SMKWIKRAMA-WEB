<div>
  <section class="p-2 pt-md-5 p-md-5 text-center " style="background-color: #0099FF">
    <h1 class="mb-3 font-bold text-white">Competence in General Performance</h1>
    <h5 class="mb-3 text-white px-md-5 px-0">Communication skill / kemampuan berkomunikasi. Adaptibility skill (fast learner) / kemampuan beradaptasi.Time management skill / kemampuan manajemen waktu</h5>
