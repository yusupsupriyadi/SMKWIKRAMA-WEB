        ...
        <div class="container ">
            ...
            <div class="row text-center pt-md-3 pt-1">
                <div class="col-md">
                    ...
                    <p class="text-md">Bisnis Daring dan Pemasaran adalah kompetensi keahlian yang mempelajari dasar-dasar kemampuan serta keilmuan menjadi seorang marketing, dimana siswa akan mempelajari ilmu dasar marketing, pengadministrasian barang , bisnis retail , serta kemampun praktik penjualan.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div>
                <div class="row d-flex justify-content-end">
                    <div class="col my-auto">
                        <div class="text-end">
                            <h1 class="text-end font-bold text-gray-800">Video Pilihan</h1>
                            <p class="text-end text-lg text-gray-800 ">7 Jurusan SMK Wikrama Bogor</p>
                        </div>
                    </div>
                    <div class="col">
                        <img src="{{ asset('photo/bdp.png') }}" alt="">
                    </div>
                </div>
            </div>
            <!-- Section: Iframe -->
